							...
							<ul id="login-dp" class="dropdown-menu">
								<li>
									<div class="row">
										<div class="col-md-12">
<!-- 											<div class="form-group"> -->
<%-- 												<a href="myPage.do?messager=${sessionScope.loginId}" --%>
<!-- 													class="btn btn-primary btn-block">MyProfile</a> -->
<!-- 											</div> -->
											...
											<div class="form-group" id="myProfileSession" style="display: none;">
												<table>
													<tr>
											...
											<div class="form-group">
												<a href="changeProfileForm.do?id=${memberInfo.id}" class="btn btn-primary btn-block">ChangeProfile</a>
											</div>
